...
const en: Dict = {
  ...
  // Loads screen (Active / Waiting / Delivered) + multi-load confirmations
  "menu.loads": "Loads",
  "loads.title": "Loads",
  "loads.active": "ACTIVE",
  "loads.waiting": "WAITING",
  "loads.delivered": "DELIVERED",
  "loads.activeBadge": "IN PROGRESS",
  "loads.selectedBadge": "SELECTED",
  "loads.waitingBadge": "NOT PICKED UP",
  "loads.tapToDrive": "Tap to open on main screen",
  "loads.pickupOn": "Pickup: {date}",
  "loads.emptyActive": "No active load — pick one up from Waiting.",
  "loads.emptyWaiting": "No upcoming pickups.",
  "loads.emptyDelivered": "No delivered loads yet.",
  "confirm.arriveTitle": "Arrival detected",
  "confirm.departTitle": "Departure detected",
  "confirm.arriveMsg": "Arrived at {kind} for load {load} ({place})?",
  "confirm.departMsg": "Departed {kind} for load {load} ({place})?",
  "confirm.pickup": "pickup",
  "confirm.delivery": "delivery",
  "confirm.yes": "Yes, load {load}",
  "confirm.otherLoad": "No, it's load {load}",
  "confirm.notNow": "Not now",
...
const es: Dict = {
  ...
  "menu.loads": "Cargas",
  "loads.title": "Cargas",
  "loads.active": "ACTIVAS",
  "loads.waiting": "EN ESPERA",
  "loads.delivered": "ENTREGADAS",
  "loads.activeBadge": "EN CURSO",
  "loads.selectedBadge": "SELECCIONADA",
  "loads.waitingBadge": "SIN RECOGER",
  "loads.tapToDrive": "Toque para abrir en la pantalla principal",
  "loads.pickupOn": "Recogida: {date}",
  "loads.emptyActive": "Sin carga activa — recoja una de En espera.",
  "loads.emptyWaiting": "Sin recogidas próximas.",
  "loads.emptyDelivered": "Aún no hay cargas entregadas.",
  "confirm.arriveTitle": "Llegada detectada",
  "confirm.departTitle": "Salida detectada",
  "confirm.arriveMsg": "¿Llegó a la {kind} de la carga {load} ({place})?",
  "confirm.departMsg": "¿Salió de la {kind} de la carga {load} ({place})?",
  "confirm.pickup": "recogida",
  "confirm.delivery": "entrega",
  "confirm.yes": "Sí, carga {load}",
  "confirm.otherLoad": "No, es la carga {load}",
  "confirm.notNow": "Ahora no",
